  ...
  <div className="relative z-10 w-full mx-4 sm:mx-6 md:mx-8 lg:mx-10 my-4 sm:my-6 md:my-8">
    <div className="flex flex-col lg:flex-row items-end gap-8 lg:gap-10 justify-between">
      ...
      <div className="w-full lg:w-5/12 ml-auto">
        <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-6 md:p-7 lg:p-8 xl:p-10">
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            {/* Mobile Field */}
            <div>
              <label htmlFor="mobile" className="block text-sm sm:text-base font-medium text-gray-700 mb-1">
                Mobile No.
              </label>
              <input
                type="tel"
            ...
            {/* Country Field */}
            <div>
              <label htmlFor="country" className="block text-sm sm:text-base font-medium text-gray-700 mb-1">
                Country
              </label>
              <select
                id="country"
